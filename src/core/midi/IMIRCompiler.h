...
// Their responsibility is taking a high-level intent (MIR) and a Harmonic
// Context, resolving any non-destructive User Edits (DeltaGraph), and
// outputting Literal MIDI.
// -----------------------------------------------------------------------------
